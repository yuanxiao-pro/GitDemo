						...
						<div class="container-wapper">
							<ul class="zentimo-clone-mobile-menu zentimo-nav main-menu "
								...
								<li class="menu-item menu-item-has-children"><a
									...
									<ul class="submenu">
										<li class="menu-item">
											<!-- --> <a href="selectAll.do">Grid Fullwidth</a> <!-- href="selectByPage.do" -->
										</li>
									</ul></li>
						...
						<div class="col-lg-8 silider-wrapp">
							<div class="home-slider">
								...
								<div class="slider-owl owl-slick equal-container nav-center"
									...
									<c:choose>
										<c:when test="${showAdvert != null }">

											<!-- map -->

											<c:forEach var="advert" items="${showAdvert.goodInfo}"
												varStatus="status">
												...
												<div class="slider-item style7" >
													<div class="slider-inner equal-element">
														<div class="slider-infor">
															...
															<h5 class="title-big">${advert.goodName }</h5>
															
															<c:forEach var="ad" items="${showAdvert.adInfo}">
																<h3 class="title-big">${ad.addContext }</h3>
															</c:forEach>


															<div class="price">
																New Price: <span class="number-price"> $:
																	${advert.goodPrice } </span>
															</div>
															<a href="selectByGoodId.do?goodId=${advert.goodId }"
